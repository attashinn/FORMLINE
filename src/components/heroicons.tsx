...
import arrowUpTraySvg from "../../heroicons-master/optimized/24/outline/arrow-up-tray.svg?raw";
import documentSvg from "../../heroicons-master/optimized/24/outline/document.svg?raw";
import globeAltSvg from "../../heroicons-master/optimized/24/outline/globe-alt.svg?raw";
...
export const ArrowUpTray = createIcon("ArrowUpTray", arrowUpTraySvg);
...
export const User = createIcon("User", userSvg);
