...
export const FORM_TEMPLATES: FormTemplate[] = [
  {
    ...
    fields: [
      ...
      { id: "website", type: "text", label: "Website", placeholder: "https://" },
      {
        ...
        required: true,
        placeholder: "Goals, audience, deliverables…",
      },
      {
        id: "budget",
        type: "select",
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "email", type: "email", label: "Email (optional)" },
      {
        ...
        options: ["★★★★★ Excellent", "★★★★ Great", "★★★ Okay", "★★ Poor", "★ Terrible"],
        required: true,
      },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "phone", type: "tel", label: "Phone" },
      {
        ...
        options: ["Design", "Engineering", "Product", "Marketing", "Operations"],
        required: true,
      },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "name", type: "text", label: "First name" },
      {
        ...
        options: ["Product updates", "Design tips", "Behind the scenes", "All of it"],
      },
